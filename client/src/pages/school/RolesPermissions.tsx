...
export default function RolesPermissions() {
  ...
  return (
    <div className="p-8">
      ...
      <div className="bg-surface rounded-2xl border border-black/5 shadow-sm p-5 mt-6 flex gap-2">
        <input placeholder="New custom role name (e.g. Campus Coordinator)" value={newRole} onChange={(e) => setNewRole(e.target.value)} className="flex-1 border border-black/10 rounded-lg px-3 py-2 text-sm" />
      ...
      <div className="space-y-6 mt-6">
        {permissions.map((perm) => (
          <div key={perm._id} className="bg-surface rounded-2xl border border-black/5 shadow-sm overflow-hidden">
