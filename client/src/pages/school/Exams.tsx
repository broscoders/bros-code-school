...
export default function Exams() {
  ...
  const publishResults = async () => {
    ...
    alert("Results published. Students and parents can now see them.");
  };
    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-2 gap-6 mt-6">
        ...
        <div className="bg-surface rounded-xl border border-black/5 shadow-sm p-5">
          ...
          {resultForm.examId && (
            <button onClick={publishResults} className="border border-primary text-primary px-4 py-2 rounded-md text-sm font-medium w-full mt-3 hover:bg-primary/5 transition-colors">
