    ...
    <div className="p-8">
      ...
      <div className="bg-surface rounded-xl border border-black/5 shadow-sm p-5 mt-6">
        ...
        <div className="flex gap-2">
          <input placeholder="e.g. Mon-Fri 4:00 PM - 5:00 PM" value={hours} onChange={(e) => setHours(e.target.value)} className="flex-1 border border-black/10 rounded-md px-3 py-2 text-sm" />
      ...
      <div className="bg-surface rounded-xl border border-black/5 shadow-sm p-5 mt-4">
        ...
        <form onSubmit={addSlot} className="flex gap-2 mb-4">
          ...
          <input placeholder="Time e.g. 10:00 AM" value={form.time} onChange={(e) => setForm({ ...form, time: e.target.value })} className="border border-black/10 rounded-md px-3 py-2 text-sm" required />
