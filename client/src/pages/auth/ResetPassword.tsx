        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              placeholder="123456"
              className="w-full bg-white/5 border border-white/15 rounded-lg px-3.5 py-2.5 text-center text-lg tracking-[0.5em] text-white placeholder-white/25 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-colors"
              required
            />
          </div>
