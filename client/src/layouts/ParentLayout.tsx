...
import { LayoutDashboard, CalendarCheck, ClipboardCheck, Award, Wallet, Megaphone, LogOut, MessageSquare, Users, FileWarning, Menu, X, HeartPulse, AlertTriangle, Trophy, CalendarDays } from "lucide-react";
...
const navItems = [
  ...
  { to: "/parent/achievements", label: "Achievements", icon: Trophy },
];
