...
import { addVehicle, getVehicles, updateVehicleStatus, assignStudentToVehicle, getTransportAssignments, removeTransportAssignment } from "../controllers/transportController";
...
router.put("/vehicles/:id/status", protect, requireRole(...TRANSPORT_STAFF), updateVehicleStatus);
